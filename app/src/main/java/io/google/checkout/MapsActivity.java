...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, ChildEventListener {
    ...
    private static final String FIREBASE_URL ="https://fiery-heat-2558.firebaseio.com/";
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //Pad the map controls to make room for the button
        ...
        mMap.setOnMyLocationChangeListener(new GoogleMap.OnMyLocationChangeListener() {
            ...
            public void onMyLocationChange(Location location) {
                ...
                //We only want to grab the loaction once, yo allow the user to pan and zoom
